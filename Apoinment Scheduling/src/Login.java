...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("LOGIN");
        setPreferredSize(new java.awt.Dimension(615, 420));
        ...
        jLabel4.setText("I don't have and account");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!"".equals(email) && !"".equals(password)) {
            ...
            try {
                reader = new FileReader("src/Profiles.txt");
...
//                    System.out.println("Name: " + profile[0] + "\nEmail: " + profile[1] + "\nPassword: " + profile[2]);
                    ...
                    if ((email.equals(profile[3])) && password.equals(profile[4]) && ("0".equals(profile[5]) || "1".equals(profile[5]))) {

                        System.out.println("Login as an admin Successfully");
                    ...
                    if ((email.equals(profile[3])) && password.equals(profile[4]) && "2".equals(profile[5])) {

                        System.out.println("Login as an Patient Successfully");
                        JOptionPane.showMessageDialog(null,
                                "Login Successfully",
                                "Login Status",
                                JOptionPane.INFORMATION_MESSAGE);
